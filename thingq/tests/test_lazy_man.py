...
class TestManQ(
    ...
    def setUp(self):
        from thingq.lazy.core import manq
        self.qclass = manq
...
class TestManFilterQ(Manning, MFilterQMixin):
    ...
    def setUp(self):
        self.maxDiff = None
        from thingq.lazy.core import mfilterq
...
class TestManSliceQ(Manning, MQMixin, MSliceQMixin):
    ...
    def setUp(self):
        from thingq.lazy.core import msliceq
        self.qclass = msliceq
...
class TestManCollectQ(Manning, MQMixin, MCollectQMixin):
    ...
    def setUp(self):
        from thingq.lazy.core import mcollectq
...
class TestManSetQ(Manning, MQMixin, MSetQMixin):
    ...
    def setUp(self):
        from thingq.lazy.core import msetq
        self.qclass = msetq
...
class TestManMap(Manning, MQMixin, MMapQMixin):
    ...
    def setUp(self):
        from thingq.lazy.core import mmapq
        self.qclass = mmapq
...
class TestManRepeatQ(Manning, MQMixin, MRepeatQMixin):
    ...
    def setUp(self):
        from thingq.lazy.core import mrepeatq
...
class TestManOrderQ(Manning, MQMixin, MOrderQMixin):
    ...
    def setUp(self):
        from thingq.lazy.core import morderq
        self.qclass = morderq
...
class TestManRandomQ(Manning, MQMixin, MRandomQMixin):
    ...
    def setUp(self):
        from thingq.lazy.core import mrandomq
...
class TestManReduceQ(Manning, MQMixin, MReduceQMixin):
    ...
    def setUp(self):
        from thingq.lazy.core import mreduceq
...
class TestManMathQ(Manning, MQMixin, MMathQMixin):
    ...
    def setUp(self):
        from thingq.lazy.core import mmathq
        self.qclass = mmathq
...
class TestManTruthQ(Manning, MQMixin, MTruthQMixin):
    ...
    def setUp(self):
        from thingq.lazy.core import mtruthq
        self.qclass = mtruthq
